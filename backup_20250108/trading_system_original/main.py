...
class TradingSystemLauncher:
    ...
    async def initialize_system(self):
        ...
        try:
            self.logger.info("="*60)
            self.logger.info("🚀 Trading System v3.0 - 모듈화 버전 시작")
            self.logger.info("="*60)
    ...
    def run_web_server(self):
        ...
        self.logger.info("🌐 웹 서버 시작 중...")
        self.logger.info("📊 대시보드: http://localhost:8000")
    ...
    async def run_with_web_server(self):
        ...
        web_task = asyncio.create_task(
            asyncio.to_thread(self.run_web_server)
        )
