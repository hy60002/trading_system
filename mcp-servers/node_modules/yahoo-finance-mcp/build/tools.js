...
export async function getTrendingSymbols(params) {
...
export async function getMarketSummary(params) {
    ...
    const quotes = await Promise.all(indices.map(symbol => yahooFinance.quote(symbol)));
    const marketSummary = {
...
export async function getDailyGainers(params) {
...
export async function getDailyLosers(params) {
    const { count = 10 } = params;
    try {
...
export async function getQuoteSummary(params) {
